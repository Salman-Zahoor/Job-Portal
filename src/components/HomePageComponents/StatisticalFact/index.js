...
const StatisticalFact = ({ allUsers, allOrganizations }) => {
    return (
        <Box component="div" sx={{
            background: "linear-gradient(0deg,rgba(61,194,236) 39%, rgba(61,194,236) 100%),url(https://webstrot.com/html/jbdesk/main_version/main_pages/images/counter_bg.jpg)",
