...
import { loginImage,registerImage,newVector } from "../../../constants/Images";
               ...
               <div className="row d-flex justify-content-center align-items-center">
                   <div className="col-md-6">
                    <div className="login__image">
                      <img src={newVector} alt={newVector} className="img-fluid"/>
                    </div>
                   </div>
                   <div className="col-md-6">
                   <div className="hero_section_content">
                            ...
                            <Button className="resume-button " style={{backgroundColor:primaryColor, color:"white"}} onClick={()=>handleClickResume()} >
                                  Create Resume
                             </Button>
                            </div>
                        </div>
