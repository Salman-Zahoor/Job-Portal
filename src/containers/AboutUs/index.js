      ...
      <Container>
        <Grid container marginTop={2} spacing={2} justifyContent="space-between">
          <Grid item xs={12} md={5.5}>
            ...
            >
              WHY CHOOSE Jobia?
              <p style={{ color: primaryColor, fontSize: "16px" }}>Jobia provides the best job solution !</p>
            </Typography>
            <Typography
              variant="h2"
            ...
            >
              Dear Jobia is a platform is not only job seeker but also organization.
              ...
              Basically our Jobia help to find the best job for employess
            </Typography>
          </Grid>
          <Grid item xs={12} md={5.5}>
